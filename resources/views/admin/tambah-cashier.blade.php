<x-app-layout title="Tambah Kasir">
    ...
    <div class="bg-lB w-1/2 p-3 border-2 border-black rounded-md shadow-md">
        <div class="mb-5 flex justify-between relative">
            ...
            <div class="absolute inset-0 flex items-center justify-center">
                <h1 class="font-poppins text-4xl font-bold">Tambah Kasir</h1>
            </div>
        </div>

        <form action="{{ route('admin.simpan-cashier') }}" method="POST" class="font-roboto">
            @csrf
