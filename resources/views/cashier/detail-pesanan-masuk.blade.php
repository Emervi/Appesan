<x-app-layout :title="'Detail Pesanan Masuk'">
    ...
    <div class="w-full">
        ...
        <div class="bg-mB p-4 border-2 border-black flex flex-col items-center">
            @foreach ($order as $data)
                <div class="flex items-center border border-black rounded-lg p-2 bg-gray-50 mb-1 w-1/2">
                    ...
                    <div class="ml-4 flex-1 flex justify-between">
                        <div>
                            ...
                            <p class="text-gray-500">Qty: {{ $data->quantity }}</p>
                        </div>
        ...
        {{-- Footer status --}}
        <div class="bg-mY font-semibold text-xl flex justify-between p-2 border-2 border-t-0 border-black rounded-bl-lg rounded-br-lg font-poppins">
